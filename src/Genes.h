...
//////////////////////////////////
    ...
    public:
        ...
        // Randomize traits based on parameters
        void InitTraits(const std::map< std::string, TraitParameters >& tp)
        {

        }

        // Initialize traits based on parameters and other link
        void InitTraits(const std::map< std::string, TraitParameters >& tp, const LinkGene& ol)
        {
...
////////////////////////////////////
    ...
    public:
        ...
        // Randomize based on parameters and two neuron instances
        void InitTraits(const std::map< std::string, TraitParameters >& tp, const NeuronGene& n1, const NeuronGene& n2)
        {
