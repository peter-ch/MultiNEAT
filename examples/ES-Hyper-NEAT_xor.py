...
def evaluate_xor(genome):
    ...
    try:
        ...
        genome.Build_Evolvable_Substrate(net, substrate, params)
        error = 0
        depth = 5
        correct = 0.0
...
def getbest():
    g = NEAT.Genome(0, 7, 2, NEAT.ActivationFunction.SIGNED_SIGMOID,NEAT.ActivationFunction.SIGNED_SIGMOID,
            params)
